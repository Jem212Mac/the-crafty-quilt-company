...
| ------------ | ------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1            | Check that a user can register for an account.                                                         | Click on Register and input a username and password.                                   | A password should be required to be input twice.                                                                                                                                                                                                                                                            |
| 2            | Check that the user receives a verification email after registering.                                   | Once registered, check for an email requesting the user to verify their email address. | An email should be sent to the user with a link for verification.                                                                                                                                                                                                                                           |
